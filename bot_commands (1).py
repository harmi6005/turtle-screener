...
- ⭐ "명령어목록"(및 "명령어 목록") 명령 추가. 기존 "명령어확인"/"도움말"/"help"와
  ...
  더 직관적인 표현으로도 명령어 안내를 볼 수 있도록 HELP_WORDS에 동의어로 추가함.
  새 명령을 만든 게 아니라 기존 도움말 트리거에 별칭을 하나 더 단 것뿐이라,
  앞으로 새 명령을 추가할 때 HELP_TEXT만 갱신하면 "명령어목록"에도 자동 반영됨.
...
# 2026-09-24 변경: '명령어목록'/'명령어 목록'을 동의어로 추가 (기존 명령어확인/도움말/help와 동일하게 동작)
HELP_WORDS = ('명령어확인', '명령어 확인', '명령어목록', '명령어 목록', '도움말', 'help', '/help')
RESET_WORD = '보유종목 초기화'
...
HELP_TEXT = (
    ...
    "명령어목록 (명령어확인/명령어 확인/도움말/help도 동일)\n"
    "  이 도움말을 다시 보여줌"
)
